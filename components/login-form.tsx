    ...
    return(
        <div className="h-[90vh] backdrop content-center">
            <form className="flex flex-col place-items-center gap-25 mx-30 p-15 border-5 border-purple-600 rounded-2xl bg-white">
                <input type="text" id="username" placeholder="UserName" className="border-2 p-1 rounded-2xl w-[50%] text-3xl"></input>
                <input type="text" id="password" placeholder="Password" className="border-2 p-1 rounded-2xl w-[50%] text-3xl"></input>
